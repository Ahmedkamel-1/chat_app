...
const MessageContainer = ({onBackUser}) => {
  ...
  return <>
    <div className='bg-black md:min-w-[500px] h-[99%] flex flex-col py-2'>
        ...
        <div className="flex gap-2 md:justify-between items-center w-full">
          ...
          <div className="flex justify-between mr-2 gap-2">
            <div className="self-center">
              ...
              src={selectedConversation?.profilepic} alt="" />
            </div>
      ...
      <form onSubmit={handelSubmit} className='rounded-full text-black'>
        <div className="w-full rounded-full flex items-center bg-white">
          <input type="text" value={sendData} onChange={handelMessage} required id='message' 
